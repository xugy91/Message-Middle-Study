...
public class PSConsumer1 {
    ...
    public static void consumeEmail() throws IOException, TimeoutException, InterruptedException {
        ...
        // 声明队列
        channel.queueDeclare(CommonConsant.EXCHANGE_NAME_EMAIL, false, false, false, null);

        // 将队列绑定到交换机
        channel.queueBind(CommonConsant.EXCHANGE_NAME_EMAIL, CommonConsant.EXCHANGE_NAME, "");
        ...
        channel.basicConsume(CommonConsant.EXCHANGE_NAME_EMAIL, autoAck, consumer);
